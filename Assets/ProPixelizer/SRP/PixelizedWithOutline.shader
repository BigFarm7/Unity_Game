 ...
 Properties
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Add any instance-specific properties here
            ...
            v2f outline_vert(appdata v)
            {
                ...
                o.pos = TransformObjectToHClip(v.vertex); // Modified line
                o.normal = TransformObjectToWorldNormal(v.normal); // Modified line
                return o;
            }

            float4 outline_frag(v2f i) : SV_Target // Changed fixed4 to float4
            {
                // Existing fragment shader code
                return float4(1.0, 0.0, 0.0, 1.0); // Example output color
            }
            ENDHLSL
        }
    }
